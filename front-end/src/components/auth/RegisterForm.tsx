...
import { registerRequest, validateInviteRequest } from "../../api/requestAuth";
import axios from "axios";
import { useAuthStore } from "../../store/auth.store";
import { connectSocket } from "../../socket/socketClient";
import Logo from "../../assets/image/message-image.png";
import { generateAndStoreKeyPair, exportPublicKeyBase64 } from "../../socket/crypto";
...
export default function RegisterForm() {
    ...
    // Invite-related state. If an ?invite=... token is present in the
    // URL, we validate it on mount, lock the email field to whatever was
    // invited, and block signup if the invite turns out to be invalid.
